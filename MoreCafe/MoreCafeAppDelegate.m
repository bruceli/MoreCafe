...
-(void)preload
{
	// preload DTAttributedTextView 
	CGFloat height = [MaUtility estimateHeightBy:@"TEST" image:nil];
	DTAttributedTextView * textPreload = [[DTAttributedTextView alloc]initWithFrame:CGRectMake(20,220,280,height)];
	textPreload.autoresizingMask = UIViewAutoresizingFlexibleWidth;
	textPreload.backgroundColor = [UIColor clearColor];
	textPreload.scrollEnabled = NO;
	[MaUtility fillText:@"TEST" to:textPreload];
}
