...
-(void)initLoginView
{
	...
	CGRect frame = CGRectMake(0, bounds.origin.y, bounds.size.width, bounds.size.height - MA_TOOLBAR_HEIGHT);
	_loginView = [[UIView alloc] initWithFrame:frame];
	UIImageView *backgroundImageView = [[UIImageView alloc] initWithFrame:self.view.frame];
	UIImage* bakImage = [UIImage imageNamed:@"loginBackground"];
	backgroundImageView.contentMode = UIViewContentModeScaleAspectFill;
	backgroundImageView.image = bakImage;	
	[_loginView addSubview:backgroundImageView];
